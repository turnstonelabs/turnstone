...
class TestVersionHtml:
    ...
    def test_vendored_katex_skipped(self):
        ...
        html = '<link rel="stylesheet" href="/shared/katex-0.18.9/katex.min.css">'
        result = version_html(html)
    ...
    def test_vendored_mermaid_skipped(self):
        ...
        html = '<script src="/shared/mermaid-12.0.0/mermaid.min.js"></script>'
        result = version_html(html)
        assert result == html  # unchanged
    ...
    def test_vendored_hls_skipped(self):
        ...
        html = '<script src="/shared/hls-1.7.3/hls.min.js"></script>'
        result = version_html(html)
        assert result == html  # unchanged
    ...
    def test_multiple_tags(self):
        ...
        html = (
            ...
            '<link rel="stylesheet" href="/shared/katex-0.18.9/katex.min.css">\n'
        ...
        assert '/shared/katex-0.18.9/katex.min.css"' in result
...
class TestRevalidatingStaticFiles:
    ...
    def test_version_named_vendor_asset_is_immutable(self, tmp_path):
        ...
        vendor_dir = tmp_path / "katex-0.18.9"
        vendor_dir.mkdir()
        ...
        with TestClient(app) as client:
            resp = client.get("/shared/katex-0.18.9/katex.min.css")
...
class TestStaticAssetCacheControl:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("katex-0.18.9/katex.min.css", "public, max-age=31536000, immutable"),
            ("hljs-11.12.0/highlight.min.js", "public, max-age=31536000, immutable"),
            ("katex-0.18.9/../private.json", "no-store"),
            (r"katex-0.18.9\..\private.json", "no-store"),
